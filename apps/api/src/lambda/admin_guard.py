...
from bcp_auth import AuthError, ValidatedClaims, validate_authorizer_claims, validate_jwt
...
def validate_admin_claims(event: dict[str, Any]) -> ValidatedClaims:
    """Validate admin JWT and return normalized claims."""
    ...
    if isinstance(jwt_claims, dict) and jwt_claims:
        return validate_authorizer_claims(
            jwt_claims,
