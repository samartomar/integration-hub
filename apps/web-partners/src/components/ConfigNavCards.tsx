  ...
  const cards: NavCard[] = [
    {
      path: "/configuration",
      label: "Overview",
      isActiveWhen: (p: string) => p === "/configuration" || p.startsWith("/builder"),
      getCount: () => totalOps,
    ...
    },
    {
      ...
      isActiveWhen: (p: string) => p === "/configuration/auth-profiles",
    ...
    },
    {
      ...
      label: "Endpoints",
      isActiveWhen: (p: string) => p === "/configuration/endpoints" || p === "/auth-endpoints",
      getCount: () => totalOps,
    ...
    },
    {
      ...
      isActiveWhen: (p: string) => p === "/configuration/access" || p === "/configuration/allowlist",
      getCount: () => totalOps,
