      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-8">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-slate-600 mb-3">
            The Integration Hub Admin Center requires Okta sign-in before any UI can load.
          </p>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-8">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-slate-600 mb-6">
            Sign in to access the Integration Hub Admin Center.
          </p>
          <button
            type="button"
            onClick={() => {
            ...
            className="px-6 py-3 text-sm font-medium text-white bg-slate-600 hover:bg-slate-700 rounded-lg transition-colors"
          >
            Click to login
          </button>
        </div>
